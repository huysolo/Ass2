...
$(document).on('click', '#close-preview1', function(){
    $('.img-preview').popover('hide');
    // Hover befor close the preview
    $('.img-preview').hover(
        function () {
            $('.img-preview').popover('show');
        },
        function () {
            $('.img-preview').popover('hide');
        }
...
$(function() {
    ...
    $('.img-preview-clear').click(function(){
        ...
        $('.img-preview-input input:file').val("");
        $(".img-preview-input-title").text("Browse");
    });
    // Create the preview image
    $(".img-preview-input input:file").change(function (){
        var img = $('<img/>', {
            id: 'dynamic',
            width:250,
            height:200
        ...
        // Set preview image into the popover data-content
        reader.onload = function (e) {
            $(".img-preview-input-title").text("Change");
